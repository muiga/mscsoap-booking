package com.mscdemosoap.config;
...
public class WebServiceConfiguration extends WsConfigurerAdapter {
    ...
    @Bean
    DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema bookingSchema) {
		DefaultWsdl11Definition wsdl11Definition = new DefaultWsdl11Definition();
		wsdl11Definition.setPortTypeName("allServiceSoapHttp");
		wsdl11Definition.setLocationUri("/all");
		wsdl11Definition.setTargetNamespace("http://com.mscdemosoap.all");
